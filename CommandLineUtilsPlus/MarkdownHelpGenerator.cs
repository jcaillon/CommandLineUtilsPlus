...
namespace CommandLineUtilsPlus {
    ...
    /// <summary>
    /// This class helps generate the documentation of a command line application in markdown format.
    /// </summary>
    public class MarkdownHelpGenerator : IHelpWriter {

        private readonly StreamWriter _writer;

        /// <summary>
        /// Initializes a new instance of <see cref="MarkdownHelpGenerator"/>.
        /// </summary>
        ...
        /// <summary>
        /// Generates the usage text of a command.
        /// </summary>
